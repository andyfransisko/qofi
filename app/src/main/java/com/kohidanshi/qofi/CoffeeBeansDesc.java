...
public class CoffeeBeansDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffee_beans_desc);

        dbHelper = new sqlLiteConfig(this);

        title = (TextView)findViewById(R.id.coffeebeans);
        desc = (TextView)findViewById(R.id.coffeebeansdesc);
