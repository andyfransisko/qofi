...
public class MokaPotCoffeeBrewing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moka_pot_coffee_brewing);

        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.mokapot_title);
        d_desc = (TextView) findViewById(R.id.mokapot_descript);
