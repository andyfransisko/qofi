...
public class AffogatoCoffeeType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_affogato_coffee_type);

        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.affogato_title);
        d_desc = (TextView) findViewById(R.id.affogato_descript);
