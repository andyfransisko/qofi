...
public class PourOverCoffeeBrewing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pour_over_coffee_brewing);
        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.pourover_title);
        d_desc = (TextView) findViewById(R.id.pourover_descript);
