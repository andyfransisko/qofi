...
public class EtchingCoffeeArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etching_coffee_art);
        ...
        d_title = (TextView) findViewById(R.id.etching_title);
        d_desc = (TextView) findViewById(R.id.etching_descript);
