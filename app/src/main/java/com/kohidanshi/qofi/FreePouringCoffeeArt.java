...
public class FreePouringCoffeeArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_pouring_coffee_art);

        dbHelper = new sqlLiteConfig(this);

        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.freepouring_title);
        d_desc = (TextView) findViewById(R.id.freepouring_descript);
