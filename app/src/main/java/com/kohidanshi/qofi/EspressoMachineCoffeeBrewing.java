...
public class EspressoMachineCoffeeBrewing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_espresso_machine_coffee_brewing);
        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.espressomachine_title);
        d_desc = (TextView) findViewById(R.id.espressomachine_descript);
