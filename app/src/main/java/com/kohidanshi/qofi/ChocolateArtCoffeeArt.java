...
public class ChocolateArtCoffeeArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chocolate_art_coffee_art);
        ...
        d_title = (TextView) findViewById(R.id.chocolateart_title);
        d_desc = (TextView) findViewById(R.id.chocolateart_descript);
