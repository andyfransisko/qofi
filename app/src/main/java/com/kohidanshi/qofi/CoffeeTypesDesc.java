...
public class CoffeeTypesDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffee_types_desc);

        dbHelper = new sqlLiteConfig(this);

        title = (TextView)findViewById(R.id.coffeetypes);
        desc = (TextView)findViewById(R.id.coffeetypesdesc);
