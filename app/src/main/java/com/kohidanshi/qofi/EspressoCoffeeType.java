...
public class EspressoCoffeeType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_espresso_coffee_type);


        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.espresso_title);
        d_desc = (TextView) findViewById(R.id.espresso_descript);
