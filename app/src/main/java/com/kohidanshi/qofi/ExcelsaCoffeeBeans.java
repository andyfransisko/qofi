...
public class ExcelsaCoffeeBeans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_excelsa_coffee_beans);

        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.excelsa_title);
        d_desc = (TextView) findViewById(R.id.excelsa_descript);
