...
public class SiphonCoffeeBrewing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siphon_coffee_brewing);
        dbHelper = new sqlLiteConfig(this);
        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.siphon_title);
        d_desc = (TextView) findViewById(R.id.siphon_descript);
