...
public class MicrofoamingCoffeeArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_microfoaming_coffee_art);

        dbHelper = new sqlLiteConfig(this);

        session = getSharedPreferences("MyPREFERENCES", Context.MODE_PRIVATE);

        d_title = (TextView) findViewById(R.id.microfoaming_title);
        d_desc = (TextView) findViewById(R.id.microfoaming_descript);
