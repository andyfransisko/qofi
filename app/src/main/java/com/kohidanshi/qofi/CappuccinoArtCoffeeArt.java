...
public class CappuccinoArtCoffeeArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cappuccino_art_coffee_art);
        ...
        d_title = (TextView) findViewById(R.id.cappuccinoart_title);
        d_desc = (TextView) findViewById(R.id.cappuccinoart_descript);
